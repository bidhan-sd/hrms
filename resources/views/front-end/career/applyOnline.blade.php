                            ...
                            <table width="100%" class="table table-bordered table-striped text-center table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Others</td>
                                        <td>
                                            <input type="text" name="other_graduation_exam" id="other_graduation_exam" class="form-control" placeholder="Exam name"/>
                                        </td>
                                        <td width="12%">
                                            <input type="text" name="other_graduation_group" id="other_graduation_group" class="form-control" placeholder="Group name"/>
                                        </td>
                                        <td width="12%">
