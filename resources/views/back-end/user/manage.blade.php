                    ...
                    <tr>
                        ...
                        <td>
                            @if($user->publication_status == 1)
                                <a href="{{ route('unpublished-user',['id' => $user->id] ) }}" class="btn btn-info btn-sm" title="Published">
                                    <i class="fas fa-arrow-up"></i>
                                </a>
                            @else
                                <a href="{{ route('published-user',['id' => $user->id] ) }}" class="btn btn-danger btn-sm" title="Unpublished">
