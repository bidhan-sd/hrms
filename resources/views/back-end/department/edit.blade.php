...
@section('body')
    <div class="back-end-mainContent">
        ...
        <div class="main_content">
            ...
            @endif
            {{ Form::open(['route'=>'update-department-info','method'=>'POST','class'=>'form-horizontal','name'=>'departmentsEditForm','id'=>'departmentsEditForm']) }}
            <div class="form-group row">
                <div class="col-md-6 offset-3">
                    <label for="post_name">Department Name <span class="required text-danger">*</span></label>
                    <input type="text" id="department_name" value="{{ $singleDepartment->department_name }}" name="department_name"  class="form-control" placeholder="Department Name">
                    <input type="hidden" id="id" name="id" value="{{ $singleDepartment->id }}" class="form-control" placeholder="Department Name">
    ...
    <script>
        document.forms['departmentsEditForm'].elements['publication_status'].value = '{{ $singleDepartment->publication_status}}';
    </script>
@endsection